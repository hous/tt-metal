...
class PerfReport:
    ...
    def assert_single_schema(self, context: str = ""):
        ...
        lines += [
            ...
            "  (b) Two genuinely different ops/families share this file — split them into "
            "separate test files, one schema per file (as perf_sfpu_reduce_row_max.py was "
            "split out of perf_eltwise_unary_sfpu.py).",
        ]
