...
Tensor fold(
    ...
    if (height_sharded_rm_fast_path) {
        ...
        return ttnn::prim::fold(processed_tensor, stride_h, stride_w, override_memory_config);
    }
    ...
    auto output_tensor = ttnn::prim::fold(processed_tensor, stride_h, stride_w, override_memory_config);
